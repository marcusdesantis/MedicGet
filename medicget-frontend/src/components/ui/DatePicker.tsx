    ...
    <div ref={rootRef} className={`relative inline-block ${className}`}>
      ...
      {open && (
        <div
          ...
          // posición sencilla, alineado a la izquierda; si se sale del viewport
          // el usuario puede scrollear horizontalmente — no vale la pena meter
          // floating-ui sólo para este caso.
        >

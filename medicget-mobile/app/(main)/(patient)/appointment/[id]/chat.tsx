/**
 * Patient — Chat de la cita (modalidad CHAT). Espejo del AppointmentChatPage
 ...
 * DocumentPicker (con fetch local + FileReader para sacar el base64).
 * El backend acepta `attachmentUrl` como data URL — mismo contrato que
 * el web.
 */

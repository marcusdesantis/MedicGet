/**
 * Clinic — Notificaciones. Lista de notificaciones del backend
 * (svc-users), con badge de no leídas y acción "marcar todas como leídas".
 *
 * Misma implementación que la del paciente/médico — sólo cambia el
 * contexto de navegación (router.back() devuelve al dashboard de clínica).
 */
